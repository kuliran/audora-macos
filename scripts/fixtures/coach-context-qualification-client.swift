...
private let qualificationTypes: [Any.Type] = [
    ...
    ChatAttachmentEvidenceTraversalOutcome.self,
    ...
    CoachProviderDataUseAssuranceError.self,
    CoachProviderDataUseAssurance.self,
    CoachProviderConfigurationBindingError.self,
    CoachProviderEstimationPolicy.self,
    CoachProviderConfigurationBinding.self,
