...
private struct DevelopmentChatCommandDTO: Decodable {
    ...
    var applicationCommand: ChatCommand {
        get throws {
            switch kind {
            ...
            case "rename":
                ...
                return .rename(try ChatID(chatId), title: title,
            ...
            case "setFilter":
                ...
                return .setFilter(try ChatFilterQuery(query))
            case "open":
            ...
            case "start":
                ...
                return .start(LibraryScope(libraryID: try LibraryID(libraryId)))
            default:
                throw ScenarioFailure.command
            }
        }
